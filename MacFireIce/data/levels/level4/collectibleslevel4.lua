...
parms = {name="lever2", img = "leverpull.png", ss_height=46, ss_width=50, ss_frames = 3, x=-200, y= pah-40, gravity="static", sensor = true, soundTouch = "lever_pull.wav",bind = platforms["plhatch"], bindTrick = bindTrick}
	...
	bindTrick = nil
	parms = {name="exit", img = "exit.png", ss_height=116, ss_width=114, ss_frames = 1, x=100, y= 100, gravity="static", sensor = true, soundTouch = "exit.wav", doPhysics = true}
...
-- 		instance.display.collision = onLocalCollision
-- instance.display:addEventListener( "collision" )
...
parms.sequenceOptions = 
{
	...
	collectibles["water1"]= water1
	  ...
	  --table.insert(collectibles, collectible:new(parms))
