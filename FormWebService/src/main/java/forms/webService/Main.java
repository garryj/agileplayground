...
public class Main {
    ...
    public static final String BASE_URI = "http://localhost:8080/formWebService/";
    ...
    public static HttpServer startServer() {
        ...
        // in forms.formWebService package
        final ResourceConfig rc = new ResourceConfig().packages("forms.formWebService");
